      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          ...
          leading: FlutterFlowIconButton(
            ...
            onPressed: () async {
              logFirebaseEvent('USER_PROFILE_chevron_left_sharp_ICN_ON_T');
              context.safePop();
            },
          ),
          title: Text(
            ...
            children: [
              ...
              Padding(
                ...
                child: InkWell(
                  ...
                  onTap: () async {
                    logFirebaseEvent('USER_PROFILE_PAGE_upload_content_ON_TAP');
              ...
              Padding(
                ...
                child: InkWell(
                  ...
                  highlightColor: Colors.transparent,
                  onTap: () async {
                    logFirebaseEvent('USER_PROFILE_PAGE_contentView_1_ON_TAP');
                    GoRouter.of(context).prepareAuthEvent();
                    await authManager.signOut();
                    GoRouter.of(context).clearRedirectLocation();

                    context.pushNamedAuth('appOpen', context.mounted);
                  },
                  child: Container(
                    width: double.infinity,
                    height: 60.0,
